...
var $author$project$Template$update = F2(
	function (computer, _v0) {
		...
		var y = _v0.b;
		return _Utils_Tuple2(
			x + $evancz$elm_playground$Playground$toX(computer.keyboard),
			y + $evancz$elm_playground$Playground$toY(computer.keyboard));
	});
...
var $author$project$Template$view = F2(
	function (computer, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return _List_fromArray(
			[
				...
				x,
				y,
				A2($evancz$elm_playground$Playground$square, $evancz$elm_playground$Playground$blue, 40))
			]);
	});
var $author$project$Template$main = A3(
	$evancz$elm_playground$Playground$game,
	$author$project$Template$view,
	$author$project$Template$update,
	_Utils_Tuple2(0, 0));
