...
var $author$project$Template$Frame = function (a) {
	return {$: 'Frame', a: a};
};
...
var $author$project$Template$init = function (_v0) {
...
var $author$project$Template$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
...
var $author$project$Template$height = 400;
var $author$project$Template$width = 400;
var $author$project$Template$centerX = $author$project$Template$width / 2;
var $author$project$Template$centerY = $author$project$Template$height / 2;
...
var $author$project$Template$render = function (count) {
	var size = $author$project$Template$width / 3;
	var x = -(size / 2);
	var y = -(size / 2);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($joakin$elm_canvas$Canvas$Settings$Advanced$translate, $author$project$Template$centerX, $author$project$Template$centerY),
...
var $author$project$Template$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2($author$project$Template$width, $author$project$Template$height),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2(0, 0),
						$author$project$Template$width,
						$author$project$Template$height),
						$author$project$Template$render(model.count)
					]))
			]));
};
var $author$project$Template$main = $elm$browser$Browser$element(
	{
		init: $author$project$Template$init,
		subscriptions: function (model) {
			return $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Template$Frame);
		},
		update: $author$project$Template$update,
		view: $author$project$Template$view
	});
_Platform_export({'Template':{'init':$author$project$Template$main(
